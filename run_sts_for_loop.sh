...
if [ "$routing_start" == "24" ]; then
    ...
    config_=trans_${transform}__rout_${router_type}_from_${routing_start}_to_${routing_end}__mask_${mask_type}_${mask_type_2}__sup_${use_supervision}_${layer_super}_margin_${margin}__lr_${lr}__wd_${wd} #__s_${seed}
else
    config_=trans_${transform}__rout_${use_condition}_t_${temperature}_from_${routing_start}_to_${routing_end}__mask_${mask_type}_${mask_type_2}__sup_${use_supervision}_${layer_super}_margin_${margin}__lr_${lr}__wd_${wd} #__s_${seed}
fi
