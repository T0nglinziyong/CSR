#!/bin/bash
export MODEL=./simcse-base #princeton-nlp/sup-simcse-roberta-base # openai/clip-vit-large-patch14 #
...
export ROUT_START=-4 # router开始的层数
export ROUT_END=0 # router结束的层数
